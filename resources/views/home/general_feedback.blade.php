...
<head>
    <title>Magician O P Sharma Jr General Feedback</title>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript">
        ...
        //     $.ajax({
        //         type: 'POST',
        //         url: '{{ route('general_feedback.store', '') }}',
        //         data: {
        //             _token: '{{ csrf_token() }}',
        //             text: textarea_val,
        //             val: feedback_type,
    ...
    function send_data() {
        ...
        var platform = result.os.name + ' ' + result.os.version;
        var device = result.device.model ? result.device.model : 'Unknown Device';
    
        // Get textarea and feedback type values
        var textarea_val = $('#textarea-box').val();
        var feedback_type = $('#feedback-hidden').val();
    ...
    <div id="content" class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        <div id="screen-score" class="col-lg-12 col-md-12 col-xs-12 col-sm-12" prev="" next="screen-touchpoint">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 message">
                <h2 style="padding-bottom:10px">Share your feedback or suggestions with Magician O.P. Sharma Jr.</h2>
            </div>
       ...
       <div class="row mybox " id="" style="display:none; "> 
              ...
              <div class="col-lg-12 " style="margin-top:-40px">
                   <input id="mobile" name="mobile" type="number"  required oninput="limitLength(this)" class="form-control" style="width:300px;margin: 15px auto;" placeholder="Your 10 Digit Mobile No. (Required)">
                   
            
                   <input id="feedback-hidden" type="hidden">
                    <textarea id="textarea-box" placeholder="Write your valuable feedback or suggestions  (Optional)"  class="form-control"  style=" width: 300px;    height: 100px; margin: 15px auto;"></textarea>
                    (Max 500 Words)<bR><bR>
              </div>
...
function limitLength(input) {
        // Define the max length you want (e.g., 5 digits)
        var maxLength = 10;
        
        // Convert the input value to a string and check the length
