<div class="stg-container" style="margin-top:0px; ">
<div class="container" style="margin-top:0px; ">
    <p style="text-align: center; margin-top:0px; font-size:25px;">
        <?php
        $seat_no_arr = [];
        $show_name = false;
        ?>
...
<section class="detail_ticket_outer_" style="padding-top:0px">
        <div class="detail_ticket_outer" id="detail_ticket_outer" style="border:1px solid black">
            <div class="detail_ticket">
                <div class="row">
                    ...
                    <img crossorigin="anonymous" src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo simple_crypt($payment_details['booking_id'])?>&size=200x200" alt="QR Code">
                        <Br>
                        ...
                        <p style="font-size:16px"> Helpline : +91-8882546585</p>
                         <!--<p style="font-size:16px d-none"> GST No. : 09AADFP9270A2Z9</p>-->
                    </div>
                    <div class="tap_detail">
                        <div class="hr"></div>
                    ...
                    <div class="amount_fr d-flex"><div class="text_total">Discount</div><h5>₹ 0</h5></div>
                     <div class="amount_fr d-flex"><div class="text_total">GST</div><h5>Nill</h5></div>
...
if ($booking->is_email_sent == 'NO') {
    ...
    $data = [];
    $data['status'] = $payment_details['status'];
    $data['booking_id'] = $payment_details['booking_id_str'];
    $data['amount'] = $payment_details['amount'];
    $data['tickets'] = $seat_no . count($seat_no_arr) . ' Ticket(s)' . ' (' . $ticket_type_name . ')' . $seat_no_message;
    $data['show_name'] = $event_date . ' ' . $event_show_time;
    $data['txnid'] = $payment_details['txnid'];
