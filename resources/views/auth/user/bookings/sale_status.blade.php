...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body">
                    <form action="{{ route('bookings.saleStatus') }}" method="GET">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="es_id" id="event_schedule_id" onchange="get_event_schedule_list_by_event_schedule_id(this.value);"  onfocus="get_event_schedule_list_by_event_schedule_id(this.value);">
                                </select>
                            </div>
                        </div>
