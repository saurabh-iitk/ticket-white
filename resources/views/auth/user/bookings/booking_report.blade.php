                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="paid_by" id="paid_by">
                                    ...
                                    <option value="{{$payment->id}}"
                                        ...
                                        <?php echo ($paid_by != null && $paid_by == $payment->id) ? 'selected' : '';?>>{{$payment->name}}</option>
                                    @endforeach
                                    @endif
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width:80px">
                                    ...
                                    <form id="{{$booking->id}}" action="{{ route('booking.unbook', $booking->encrypt_id)  }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        <button type="submit" onclick="confirm_unbook({{$booking->id}});" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                    </form>
                                    @endif
