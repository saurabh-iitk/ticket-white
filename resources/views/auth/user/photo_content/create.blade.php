...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-star-o"></i> Add Photo Content</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item active"><a href="{{ route('photo_gallery.index') }}">Photo Content List</a></li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body">
                    <form action="{{ route('photo_content.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="gallery_id">Photo Gallery <span class="required">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="cover_img">Select Photo <span class="required">*</span></label>
