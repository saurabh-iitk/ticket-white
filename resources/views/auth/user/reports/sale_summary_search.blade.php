                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="es_id" id="event_schedule_id" onchange="get_event_schedule_list_by_event_schedule_id(this.value);">
                                    ...
                                    <option value="{{$event_schedule->id}}" <?php echo ($es_id != null && $es_id == $event_schedule->id) ? 'selected' : '';?>>{{$event_schedule->start_date.' - '.$event_schedule->end_date}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="esd_id" id="event_schedule_list_id" style="width:100%;">
                                    ...
                                    <option value="{{$event_schedule_list->id}}" <?php echo ($esd_id != null && $esd_id == $event_schedule_list->id) ? 'selected' : '';?>>{{$event_schedule_list->event_date}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
