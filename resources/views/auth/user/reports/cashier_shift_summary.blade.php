...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-bar-chart"></i>Cashier Shift Summary</h1>
            </div>
        </div>
                        ...
                        <table class="table table-hover table-bordered" id="userTable">
                            ...
                            ?>
                                ...
                                if (isset($vendor->vendor_id) && getPaymentMethodByvendor($vendor->vendor_id, $start_date, $end_date)) {
                                    ...
                                    foreach ($payment_methods as $payment_method) {
                                        ...
                                        if($payment_method->name=='UPI' OR $payment_method->name=='Discount UPI')
                                        {
                                             $upi=$upi+$payment_method->amount;
                                             $upi_discount = $upi_discount  + $payment_method->discount;
                                ...
                                <tr style="background-color:#c9eaf5;">
                                    <th colspan="3" class="text-right">Total UPI</th>
                                    <th class='text-right'><?php echo number_format($upi, 2); ?></th>
                                    <th class='text-right'><?php echo number_format($upi_discount, 2); ?></th>
                                    <th class='text-right'><?php echo number_format($upi - $upi_discount, 2); ?></th>
                                </tr>
                            ...
                            <tfoot>
                                ...
                                foreach ($bookings as $booking) {
                                    ...
                                    {
                                         $upi=$upi+$amount;
                                         $upi_discount = $upi_discount  + $discount;
                                ...
                                <tr style="background-color:#c9eaf5;">
                                    <th colspan="3" class="text-right">Grand UPI</th>
                                    <th class="text-right"><?php echo number_format($upi, 2); ?></th>
                                    <th class="text-right"><?php echo number_format($upi_discount, 2); ?></th>
                                    <th class="text-right"><?php echo number_format($upi - $upi_discount, 2); ?></th>
                                </tr>
