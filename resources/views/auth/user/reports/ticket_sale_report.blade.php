...
@section('title', 'Ticket Sale Report')
...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-bar-chart"></i> Ticket Sale Report</h1>
            </div>
        </div>
                        ...
                        @if ($e_id)
                            <table class="table table-hover table-bordered" id="userTable">
                                ...
                                <tbody>
	                                ...
	                                $total_amount = $total_base_price;
	                                $total_count = $booking->total_count;

	                                $net_total_count = $net_total_count+$total_count;
	                                $net_total = $net_total+$total_base_price;
	                                $grand_total = number_format($net_total,2);
                                ?>
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                @if (getTicketType($booking->ticket_type_id))
                                                    {{ getTicketType($booking->ticket_type_id)->ticket_type_name }}
                                                @endif
                                            </td>
